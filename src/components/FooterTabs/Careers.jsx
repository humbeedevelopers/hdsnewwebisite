...
const Careers = () => {
  ...
  {
    title: 'Web Developer | GSAP Master | Web Animation',
    url: '/careers/web-developer-gsap'
  },
  {
    title: 'Social Media Manager',
    url: '/careers/social-media-manager'
  },
  {
    title: 'Senior Business Development Executive | Middle East Market',
    url: '/careers/business-development-middle-east'
  },
  {
    title: 'Sr. UI/UX Designer | Figma Expert',
    url: '/careers/ui-ux-designer-figma'
  }
];
  ...
  return (
    <div className='flex flex-col md:flex-row w-full font-montserrat justify-between mt-10 border-t border-b'>
        ...
        <div className='w-full md:w-1/2 border-l-0 md:border-l border-t md:border-t-0'>
            <h1 className="text-2xl md:text-3xl font-black p-5">Current Openings</h1>
            <div className="flex flex-col border-t border-black">
                {AvailablePositions.map((post) => (
